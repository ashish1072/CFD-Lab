...
int read_parameters( const char *szFileName,   /* name of the file */
                    char *problem,             /*name of the problem*/
		            ...
		            int *jproc)                /*Number of processes in i dir*/
{
...
void init_uvp(double UI,double VI,double PI,int il,int ir,int jb, int jt, double **U,double **V,double **P)
{
